...
hyper(organism, 1,[living_thing,animate_thing]).
...
hypo(organism, 1,[aerobe,amphidiploid,anaerobe,animal,animate_being,beast,brute,creature,fauna,animalcule,animalculum,atavist,throwback,benthos,carrier,clone,clon,commensal,conspecific,denizen,diploid,dwarf,eukaryote,eucaryote,fungus,haploid,heteroploid,heterotroph,host,hybrid,crossbreed,cross,individual,katharobe,mascot,microorganism,micro-organism,mutant,mutation,variation,sport,myrmecophile,native,nekton,nonvascular_organism,parasite,parent,person,individual,someone,somebody,mortal,soul,plankton,plant,flora,plant_life,polymorph,polyploid,postdiluvian,prokaryote,procaryote,recombinant,relative,congener,congenator,congeneric,relict,saprobe,saprophyte,saprophytic_organism,sitter,stander,utterer,vocalizer,vocaliser,zooid]).
