...
hypo(kind, 1,[antitype,art_form,brand,make,color,colour,description,flavor,flavour,genre,genus,like,the_like,the_likes_of,like,ilk,manner,model,species,stripe,style,type]).
hypo(type, 1,[breed,nature,version,variant,variation,edition]).
